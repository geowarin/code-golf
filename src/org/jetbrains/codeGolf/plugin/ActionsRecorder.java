  ...
  implements JetObject, Disposable
{
  ...
  public final void startRecording()
  {
    ...
    this.document
      ...
      public void documentChanged( DocumentEvent event) { if (this.this$0.isTaskSolved())
        {
          Application tmp13_10 = ApplicationManager.getApplication(); if (tmp13_10 == null) throw new NullPointerException(); tmp13_10.invokeLater((Runnable)new Runnable() {
    ...
    ActionManager tmp29_26 = ActionManager.getInstance(); if (tmp29_26 != null) tmp29_26
        .addAnActionListener((AnActionListener)new JetObject()
      {
        ...
        public void beforeActionPerformed( AnAction action,  DataContext dataContext,  AnActionEvent event)
        {
          ...
          {
            AnAction tmp8_7 = action; if (tmp8_7 == null) throw new NullPointerException(); tmpTernaryOp = tmp3_0.getId(tmp8_7);
          }
        }
  ...
  public final void processKeyPressedEvent( KeyEvent e)
  {
    ...
    if (KotlinPackage.setOf(new Integer[] { Integer.valueOf(KeyEvent.VK_CONTROL), Integer.valueOf(KeyEvent.VK_ALT), Integer.valueOf(KeyEvent.VK_META), Integer.valueOf(KeyEvent.VK_SHIFT) }).contains(Integer.valueOf(e.getKeyCode())))
      return;
    IdeEventQueue tmp90_87 = IdeEventQueue.getInstance(); if (tmp90_87 == null) throw new NullPointerException();
    IdeKeyEventDispatcher tmp100_97 = tmp90_87.getKeyEventDispatcher(); if (tmp100_97 == null) throw new NullPointerException(); if (!tmp100_97.isReady()) {
      return;
    }
    ...
    {
      String tmp270_267 = KeymapUtil.getKeystrokeText(KeyStroke.getKeyStrokeForEvent(e)); if (tmp270_267 == null) throw new NullPointerException(); this.usedActions.add(tmp270_267);
  ...
  public final void sendSolutionToServer()
  {
    ...
    new Task.Backgroundable(solution, passwordToSend) {
      ...
      public void run( ProgressIndicator indicator) { Intrinsics.checkParameterIsNotNull(indicator, "run");
        try
        {
          GolfResult tmp18_15 = RestClientUtil.sendSolution(this.$solution, this.$passwordToSend); if (tmp18_15 == null) throw new NullPointerException(); GolfResult result = tmp18_15;
  ...
  public final NotificationListener createNotificationListener() { return (NotificationListener)new JetObject() {
      ...
      public void hyperlinkUpdate( Notification p0,  HyperlinkEvent p1) { Intrinsics.checkParameterIsNotNull(p0, "hyperlinkUpdate"); Intrinsics.checkParameterIsNotNull(p1, "hyperlinkUpdate");

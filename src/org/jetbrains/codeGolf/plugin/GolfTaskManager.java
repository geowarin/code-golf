  ...
  implements JetObject
{
  ...
  public final void addTask( GolfTask task) { Intrinsics.checkParameterIsNotNull(task, "addTask"); this.tasks.add(task);
  }
    ...
    implements JetObject
  {
    ...
    {
      GolfTaskManager tmp8_5 = ((GolfTaskManager)ServiceManager.getService(GolfTaskManager.class)); if (tmp8_5 == null) throw new NullPointerException(); return tmp8_5;
    }
  }
}
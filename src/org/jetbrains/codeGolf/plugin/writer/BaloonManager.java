  ...
  public static void ShowBalloonForTransformTask(final String oldCode, final int initialOffset, final PsiFile psiFile, final Document document, final Project project, final String username, final String password)
  {
    ...
    button.addMouseListener(new MouseAdapter() {
      public void mouseClicked(@NotNull MouseEvent mouseEvent) {
        if (mouseEvent == null) throw new IllegalArgumentException("Argument 0 for @NotNull parameter of org/jetbrains/codeGolf/plugin/writer/BaloonManager$1.mouseClicked must not be null"); if ((this.val$ref.isNull()) || (((Balloon)this.val$ref.get()).isDisposed())) return;

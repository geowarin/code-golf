...
import org.jetbrains.codeGolf.plugin.PluginPackage.src.CodeGolfConfigurable.-89488205;
import org.jetbrains.codeGolf.plugin.PluginPackage.src.LoginWithJBAccount.1403856597;
  ...
  implements JetObject
{
  ...
  public void update(@JetValueParameter(name="e", type="?Lcom/intellij/openapi/actionSystem/AnActionEvent;") AnActionEvent e)
  {
    ...
    Presentation tmp11_8 = tmp1_0.getPresentation(); Intrinsics.checkReturnedValueIsNotNull(tmp11_8, "AnActionEvent", "getPresentation");
    Presentation tmp19_11 = tmp11_8; if (tmp19_11 == null) Intrinsics.throwNpe();
    AnActionEvent tmp28_27 = e; 1; if ((tmp28_27 != null ? tmp28_27.getProject() : null) == null) tmp19_11; tmp19_11.setVisible(0 != 0 ? AuthPackage.hasAdminAccess(PluginPackage.src.CodeGolfConfigurable.-89488205.getUserName()) : false);
  }
  ...
  public void actionPerformed(@JetValueParameter(name="e", type="?Lcom/intellij/openapi/actionSystem/AnActionEvent;") AnActionEvent e)
  {
    ...
    if (usernameAndPassword != null) 1; if (0 != 0) return;

    Pair localPair1 = usernameAndPassword; String username = (String)localPair1.component1(); String password = (String)localPair1.component2(); localPair1 = null;
    ...
    AnActionEvent tmp81_80 = e; if (tmp81_80 == null) Intrinsics.throwNpe(); doAdminAction(project, tmp81_80, username, password); } 
  @JetMethod(flags=32, returnType="V")
  protected abstract void doAdminAction(@JetValueParameter(name="project", type="Lcom/intellij/openapi/project/Project;") Project paramProject, @JetValueParameter(name="e", type="Lcom/intellij/openapi/actionSystem/AnActionEvent;") AnActionEvent paramAnActionEvent, @JetValueParameter(name="username", type="Ljava/lang/String;") String paramString1, @JetValueParameter(name="password", type="Ljava/lang/String;") String paramString2);

  @JetClass(signature="Ljava/lang/Object;", flags=16, abiVersion=6)
  @JetClassObject
  public static final class object implements JetObject { @JetMethod(flags=16, returnType="V")
    public final void sendTaskToServer(@JetValueParameter(name="project", type="Lcom/intellij/openapi/project/Project;") Project project, @JetValueParameter(name="task", type="Lorg/jetbrains/codeGolf/plugin/GolfTask;") GolfTask task, @JetValueParameter(name="password", type="Ljava/lang/String;") String password) { Intrinsics.checkParameterIsNotNull(project, "sendTaskToServer"); Intrinsics.checkParameterIsNotNull(task, "sendTaskToServer"); Intrinsics.checkParameterIsNotNull(password, "sendTaskToServer"); new Task.Backgroundable(project, password) { // ERROR //
        @JetMethod(returnType="V")
        public void run(@JetValueParameter(name="indicator", type="Lcom/intellij/openapi/progress/ProgressIndicator;") com.intellij.openapi.progress.ProgressIndicator indicator) { // Byte code:
          //   0: aload_1
          //   1: ldc 33

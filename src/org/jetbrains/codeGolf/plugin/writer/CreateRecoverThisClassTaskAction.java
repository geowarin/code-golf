...
public final class CreateRecoverThisClassTaskAction extends AdminActionBase
    ...
    protected void doAdminAction(Project project, AnActionEvent anActionEvent, String username, String password) {
        Intrinsics.checkParameterIsNotNull(project, "doAdminAction");
        Intrinsics.checkParameterIsNotNull(anActionEvent, "doAdminAction");
        Intrinsics.checkParameterIsNotNull(username, "doAdminAction");
        Intrinsics.checkParameterIsNotNull(password, "doAdminAction");
        Editor editor;
        DataKey tmp28_25 = PlatformDataKeys.EDITOR;
        Intrinsics.checkFieldIsNotNull(tmp28_25, "PlatformDataKeys", "EDITOR");
        DataKey tmp36_28 = tmp28_25;
        if (tmp36_28 != null) {
            DataContext tmp44_41 = anActionEvent.getDataContext();
            Intrinsics.checkReturnedValueIsNotNull(tmp44_41, "AnActionEvent", "getDataContext");
